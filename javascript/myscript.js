...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp tim của anh " + (thePercent+899) + " là do ...";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Tim anh đập nhanh vậy là vì:';
document.querySelector('.Description .modal-body').innerHTML = 'Anh yêuuu công chúa nhiều lắm lun đó trừi ưi <i class="fas fa-heart"></i> ';
